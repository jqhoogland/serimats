...
from serimats.paths.types_ import ParameterOrTensor
from serimats.paths.utils import get_parameters
from serimats.paths.variables.weight_init import FlattenedKaimingHe

if TYPE_CHECKING:
    from serimats.paths.variables.weight_init import WeightInitializer
